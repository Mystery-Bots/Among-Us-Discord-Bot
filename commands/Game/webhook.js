module.exports.run = async (bot, message, args, database) => {
    ...
    if (args[0].toLowerCase() == "unmute"){return await require("./wehookCommands/unmute").run(bot, message,args, database)}
    if (args[0].toLowerCase() == "end"){return await require("./wehookCommands/end").run(bot, message,args, database)}
